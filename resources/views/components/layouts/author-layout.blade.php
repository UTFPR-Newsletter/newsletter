...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Área do Autor</title>
...
<body class="min-h-screen bg-white">
    ...
    <div x-data="authorPage()" x-init="init()">
            ...
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center">
                    ...
                    <nav class="flex space-x-6" aria-label="Navigation menu">
                        <a href="#"
                            class="transition-all duration-200 relative nav-link {{ request()->routeIs('author.dashboard') ? 'text-gray-900 font-medium active-tab' : 'text-gray-600 hover:text-gray-800 hover:font-medium' }}">
                            Home
                        </a>
                        <a href="#"
                            class="transition-all duration-200 relative nav-link {{ request()->routeIs('author.newsletters') ? 'text-gray-900 font-medium active-tab' : 'text-gray-600 hover:text-gray-800 hover:font-medium' }}">
                            Newsletters
                        </a>
                    </nav>
                </div>
                ...
                <div class="relative" x-data="{ isMenuOpen: false }">
                    ...
                    <button @click="isMenuOpen = !isMenuOpen" class="flex items-center space-x-3 p-2 bg-white rounded-lg text-gray-800 hover:bg-gray-50 transition-colors duration-200 border border-gray-200">
                        ...
                        @endif
                        <span class="text-sm font-medium truncate max-w-24">{{ $user->author->aut_name }}</span>
                    ...
                    <div x-show="isMenuOpen"
                        ...
                        <div class="px-4 py-3 border-b border-gray-100">
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-medium text-gray-900 truncate">{{ $user->author->aut_name }}</p>
                        ...
                        <div class="py-2">
                            <a href="{{ route('author.profile') }}" class="w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 flex items-center">
                                <i class="fad fa-user-edit text-blue-500 mr-3"></i>
                                Meu Perfil
                            </a>
                            <a href="{{ route('author.profile', ['activeTab' => 'password']) }}" class="w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 flex items-center">
            ...
            <div class="container mx-auto px-4 py-6 flex items-center justify-between" x-ref="mainHeader">
                ...
                <div class="relative" x-data="{ isMenuOpen: false }">
                    ...
                    <button @click="isMenuOpen = !isMenuOpen" class="flex items-center space-x-3 p-2 bg-white rounded-lg text-gray-800 hover:bg-gray-50 transition-colors duration-200 border border-gray-200">
                        ...
                        @endif
                        <span class="text-sm font-medium truncate max-w-32">{{ $user->author->aut_name }}</span>
                ...
                <div class="container mx-auto px-4">
                    ...
                    <span class="inline-block px-4 py-2 mt-10 bg-gray-800 text-white rounded-full text-sm font-bold mb-6">
                        @if(request()->routeIs('author.dashboard'))
                            Dashboard
                        @elseif(request()->routeIs('author.newsletters'))
                            Minhas Newsletters
                        @else
                            Área do Autor
                        @endif
