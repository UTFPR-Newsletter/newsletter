                    ...
                    <nav class="-mb-px flex space-x-8">
                        <button
                            ...
                            :class="{'border-gray-800 text-gray-800': activeTab === 'magic-login',
                                    'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'magic-login'}"
                        ...
                        <button
                            ...
                            :class="{'border-gray-800 text-gray-800': activeTab === 'edit-profile',
                                    'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'edit-profile'}"
                            class="py-4 px-1 border-b-2 font-medium text-sm">
                        ...
                        <button
                            ...
                            :class="{'border-gray-800 text-gray-800': activeTab === 'password',
                                    'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'password'}"
                            class="py-4 px-1 border-b-2 font-medium text-sm">
                    ...
                    <div x-show="activeTab === 'magic-login'" x-cloak>
                        <div class="max-w-2xl">
                            ...
                            <p class="text-gray-600 mb-4">
                                ...
                                Quando você solicita um login mágico, enviamos um e-mail com um link especial que permite acesso
