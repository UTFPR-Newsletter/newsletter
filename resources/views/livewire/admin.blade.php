...
>
        ...
        <div class="flex items-center">
            ...
            <nav class="flex space-x-6" aria-label="Navigation menu">
                <a href="#"
                    ...
                    x-bind:class="activeTab === 'home' ? 'text-gray-900 font-medium active-tab' : 'text-gray-600 hover:text-gray-800 hover:font-medium'"
                    class="transition-all duration-200 relative nav-link">
                    Home
                </a>
                <a href="#"
                    @click.prevent="activeTab = 'gestao'"
                    x-bind:class="activeTab === 'gestao' ? 'text-gray-900 font-medium active-tab' : 'text-gray-600 hover:text-gray-800 hover:font-medium'"
                    class="transition-all duration-200 relative nav-link">
                    Gestão
                </a>
                <a href="#
                    @click.prevent="activeTab = 'assinantes'
                    x-bind:class="activeTab === 'assinantes' ? 'text-gray-900 font-medium active-tab' : 'text-gray-600 hover:text-gray-800 hover:font-medium'"
                    class="transition-all duration-200 relative nav-link">
                    Assinantes
                </a>
                <a href="#"
    ...
    <div class="bg-gray-200 relative h-34">
        ...
        <div class="wave-transition">
            <div x-show="activeTab === 'home'" class="container mx-auto px-4">
                <!-- Badge -->
            ...
            <div x-show="activeTab === 'gestao'" class="container mx-auto px-4">
                <!-- Badge -->
                <span class="inline-block px-4 py-2 mt-10 bg-gray-800 text-white rounded-full text-sm font-bold mb-6">
                    Gestão do Sistema
                </span>
            ...
            <div x-show="activeTab === 'assinantes'" class="container mx-auto px-4">
                <!-- Badge -->
                <span class="inline-block px-4 py-2 mt-10 bg-gray-800 text-white rounded-full text-sm font-bold mb-6">
            ...
            <div x-show="activeTab === 'autores'" class="container mx-auto px-4">
                <!-- Badge -->
                <span class="inline-block px-4 py-2 mt-10 bg-gray-800 text-white rounded-full text-sm font-bold mb-6">
            ...
            <div x-show="activeTab === 'newsletters'" class="container mx-auto px-4">
                <!-- Badge -->
                <span class="inline-block px-4 py-2 mt-10 bg-gray-800 text-white rounded-full text-sm font-bold mb-6">
    ...
    <div class="flex-grow bg-white">
        <div class="container mx-auto px-4 py-8">
            ...
            <div x-show="activeTab === 'home'" class="content-section">
                <div class="w-full mt-8">
                    <x-dashboard.stats-grid />
                </div>
            </div>
            
            <div x-show="activeTab === 'gestao'" class="content-section">
                <div class="w-full mt-8">
                    <div class="flex flex-col items-center text-center">
                        <x-dashboard.management-grid />
                    </div>
                </div>
            </div>

            <div x-show="activeTab === 'assinantes'" class="content-section">
                <div class="w-full mt-8">
                    <div class="flex flex-col items-center text-center">
                        <!-- Add subscribers management content here -->
                    </div>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'autores'" class="content-section">
                <div class="w-full mt-8">
                    <div class="flex flex-col items-center text-center">
                        <!-- Add authors management content here -->
                    </div>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'newsletters'" class="content-section">
                <div class="w-full mt-8">
                    <div class="flex flex-col items-center text-center">
                        <!-- Add newsletters management content here -->
                    </div>
                </div>
            </div>
        </div>
