                ...
                <div class="p-4 border-b border-gray-200 bg-white">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button @click="$wire.call('showCorrectInsertModal', activeTab)" class="px-3 py-2 text-sm bg-gray-800 text-white rounded-lg hover:bg-gray-700 hover:cursor-pointer transition-colors duration-200 flex items-center">
